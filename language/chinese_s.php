...
Version 1.6.12 - Last modified 2025-06-27
...
$lang['o_chickenpaint']= 'ChickenPaint';
...
// {1} = version
// Context: database/config version numbers are usually less than code version number as they are updated less often.
$lang['up_v_detected'] = '{1} configuration detected.';

//The configuration appears to be the newest version already.  You may proceed to verify that the last update completed correctly.
$lang['up_latest_ver'] = 'The configuration appears to be the newest version already.  You may proceed to verify that the last update completed correctly.';
