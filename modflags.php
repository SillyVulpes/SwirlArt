...
Version 1.6.12 - Last modified 2025-08-06
*/
...
$h_usrname2 = w_html_chars(stripslashes($usrname2));
$modify = w_gpc('modify');


// Redirect to profile editor if needed
if ($modify == 'profile') {
	header('Location: editprofile.php?username='.urlencode(stripslashes($usrname2)));
	w_exit();
}
...
<?php
if (!isset($_GET['muser']) || empty($usrname2)) {
