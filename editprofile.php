...
Wacintaki Poteto modifications Copyright 2004-2023 Marc "Waccoon" Leveille
...
// Fix empty/null
if (!isset($current_user['url']) || trim($current_user['url']) == '') {
	$current_user['url'] = 'http://';
}
if (!isset($current_user['gender'])) $current_user['gender'] = '';
	...
	<form name="form1" method="post" action="functions.php">
		...
		<div class="infotable">
			...
			<td class="infoenter" valign="top">
				<input id="name" name="name" type="text" value="<?php echo w_html_chars($current_user['name']);?>" class="txtinput" size="40" />
			...
			<td class="infoenter" valign="top">
<?php
				$the_date = isset($current_user['age']) ? $current_user['age'] : '';
				$year = ''; $month = ''; $day = '';
...
<?php } ?>
				<br />
				<br />
				<input name="avatar" type="button" value="<?php tt('chgavatar');?>" class="submit" onclick="openWindow('edit_avatar.php?username=<?php echo urlencode(stripslashes($username));?>', 500, 400); return false;" />
			</td>
			</tr>
...
<?php } ?>
		...
		<div class="infotable">
			...
			<td class="infoenter" valign="top">
				<input name="firefox_fix" type="text" value="<?php w_html_chars($user['usrname']);?>" class="txtinput" />
			</td>
			</tr>
			...
			<td class="infoenter" valign="top">
				<input id="passwdnew" name="passwdnew" type="password" class="txtinput" />
		...
		<div class="infotable">
			<p style="text-align: center;">
				<input name="username2" type="hidden" value="<?php echo w_html_chars(stripslashes($username)); ?>" />
